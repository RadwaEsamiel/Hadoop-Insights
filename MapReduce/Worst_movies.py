...
class MoviesAvgRating(MRJob):
    ...
    def steps(self):
        return [
            ...
            MRStep(reducer=self.worst_movies)
        ]
    ...
    def worst_movies(self, _, movie_data):
        # Sort movies by average rating in ascending order (worst to best)
        sorted_movies = sorted(movie_data, reverse=False)
