...
# Sort all filtered movies by avg_rating in descending order for best-rated
...
# Show the result ordered by avg_rating from highest to lowest
movies_with_names_df.orderBy("avg_rating", ascending=False).show()
