...
filtered_highest_rated_movies = movies_count_avg[movies_count_avg.rating_count > 10]
highest_rated_movies = filtered_highest_rated_movies.head(10)

top10_highest_rated_movies = highest_rated_movies.merge(
    movies_names_df[['movie_id', 'movie_title']], 
    on='movie_id', 
    how='left'
)
print(top10_highest_rated_movies)
