...
lowest_rated_moveies = movies_count_avg.filter(col("rating_count") > 10)


top_lowest_rated_movies = lowest_rated_moveies.join(movies_names_df, on = "movie_id", how = "left")
top_lowest_rated_movies.show()
